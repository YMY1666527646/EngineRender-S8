...
inline void framework::render_menu(UCanvas* canvas)
{
	...
	Text(canvas, 175, 204, 0, FString(E(L"Micca Is Cool ")), options::Aim::memory);
	...
	if (current_tab == 2)
	{
		tab(canvas, 368, 517, x + 300, 30, FString(E(L"RAGE")), current_tab, 2, true);
	}
	else
	{
		tabinactive(canvas, 368, 517, x + 300, 30, FString(E(L"RAGE")), current_tab, 2, true);
	}

	if (current_tab == 0)
	{
		checkbox(canvas, 205, 250, x + 110, FString(E(L"Enable Aim")), options::Aim::memory);
		slider(canvas, x + 20, y + 148, 150, FString(E(L"FOV")), options::Aim::fov_range, 0.0f, 800.0f);
		slider(canvas, x + 20, y + 188, 150, FString(E(L"Smooth")), options::Aim::smooth, 0.0f, 50.f);
		checkbox(canvas, 205, 355, x + 110, FString(E(L"Hitscan")), options::Aim::RandomAimBone);
		checkbox(canvas, 205, 385, x + 110, FString(E(L"Vis Check")), options::Aim::visible_check);
	...
	if (current_tab == 1)
	{
		...
		checkbox(canvas, 205, 280, x + 110, FString(E(L"Corner")), options::Visuals::CornerBox);
		checkbox(canvas, 205, 310, x + 110, FString(E(L"Name")), options::Visuals::NameESP);
		checkbox(canvas, 205, 340, x + 110, FString(E(L"Distance")), options::Visuals::Distance);
		slider(canvas, x + 20, y + 236, 150, FString(E(L"Thickness")), options::Visuals::BoxThickness, 0.0f, 8.0f);
	...
	if (current_tab == 2)
	{
		...
		checkbox(canvas, 205, 280, x + 110, FString(E(L"Crosshair")), options::Misc::CustomCrosshair);
		checkbox(canvas, 205, 340, x + 110, FString(E(L"FOV Changer")), options::Misc::FovChanger);

		if (options::Misc::FovChanger)
		{
			slider(canvas, x + 20, y + 236, 150, FString(E(L"FOV")), options::Misc::FOV, 80.0f, 140.0f);
		}
	}
